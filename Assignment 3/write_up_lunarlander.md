...
Standard SAC is derived for continuous actions using the reparameterisation trick on a squashed-Gaussian policy, which is not applicable to discrete actions.
